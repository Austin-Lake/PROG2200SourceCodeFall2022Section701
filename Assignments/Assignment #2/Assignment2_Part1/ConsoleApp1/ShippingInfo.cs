...
{
    // 4.
    // The letter m at the end of a value means that it is a decimal value,
    // which is needed so the compiler doesn't mistake it for a double
    ...
    // 2.
    // Declaration of Low Risk Shipping Fees delegate
    public delegate void ShippingLowRiskFeesDelegate(ref decimal fee);
    ...
    abstract class ShippingDestination
        {
            ...
            public static ShippingDestination getDestinationInfo(string dest)
            {
                ...
                // 3.
                // Added 5th destination zone conditional value
        ...
        // 3.
        // Added 5th Destination Zone Class
